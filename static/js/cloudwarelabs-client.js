(function($) {
  if (!$) {
    console.log('cloudwarelabs-client depends on jquery!');
    return;
  }
  var CL = {
    apiUrl: '',
  ...
  CL.createInstance = function(cloudwareId, domId, callback) {
    ...
    $.ajax({
      ...
      beforeSend: function(request) {
        request.setRequestHeader("Authorization", 'Bearer ' + CL.token);
      },
      data: {
      ...
      success: function(resp, textStatus, xhr) {
        ...
        ws.onopen = function() {
          ...
          canvas.onmousemove = function (e) {
            ...
            var scroll_top = document.getElementById(domId).scrollTop;
